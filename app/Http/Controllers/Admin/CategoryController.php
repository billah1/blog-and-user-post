...
//This is create or index name ----- section
    ...
    {
        return view('back.category.edit',['category' => Category::find($id)]);
    }
    ...
    {
        Category::UpdateAllCategory($request,$id);
        return back()->with('success','your category Update Successfully');
    }
